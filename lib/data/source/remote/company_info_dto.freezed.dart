...
mixin _$CompanyInfoDto {
  ...
  @JsonKey(name: 'Industy')
  String? get industy => throw _privateConstructorUsedError;
...
abstract class $CompanyInfoDtoCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'Industy') String? industy});
}
    ...
    return _then(_value.copyWith(
      ...
      country: freezed == country
          ...
          : country // ignore: cast_nullable_to_non_nullable
              as String?,
      industy: freezed == industy
          ? _value.industy
          : industy // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
}
...
class _$_CompanyInfoDto implements _CompanyInfoDto {
  const _$_CompanyInfoDto(
      ...
      @JsonKey(name: 'Industy') this.industy});
  ...
  @override
  @JsonKey(name: 'Industy')
  final String? industy;

  @override
  String toString() {
    return 'CompanyInfoDto(symbol: $symbol, description: $description, name: $name, country: $country, industy: $industy)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.industy, industy) || other.industy == industy));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode =>
      Object.hash(runtimeType, symbol, description, name, country, industy);
...
abstract class _CompanyInfoDto implements CompanyInfoDto {
  const factory _CompanyInfoDto(
      ...
      @JsonKey(name: 'Industy') final String? industy}) = _$_CompanyInfoDto;
