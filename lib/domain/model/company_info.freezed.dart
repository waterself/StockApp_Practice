...
class _$_CompanyInfo implements _CompanyInfo {
  ...
  @override
  String toString() {
    return 'CompanyInfo(symbol: $symbol, description: $description, name: $name, country: $country, industy: $industy)';
  }
...
abstract class _CompanyInfo implements CompanyInfo {
  const factory _CompanyInfo(
      ...
      required final String industy}) = _$_CompanyInfo;
